...
public class XCN_AddressValidator
{
	...
	public static boolean ValidateAddress(String addr)
	{
		...
		return hash != null
				&& Arrays.equals(Arrays.copyOfRange(hash, 0, 4),
						Arrays.copyOfRange(decoded, 21, 25));
	}
	...
	private static byte[] getSha256(byte[] data, int start, int len,
			int recursion)
	{
		if (recursion == 0)
			return data;
